...
class Resource(db.Model, SerializerMixin):
    ...
    __table_args__ = (db.UniqueConstraint('name', name='unique_name'),)
...
class User(db.Model, SerializerMixin):
    ...
    task_assignments = db.relationship("TaskAssignment", backref='user')
...
class Event(db.Model, SerializerMixin):
    ...
    resources = db.relationship('Resource', backref='event')
...
class Task(db.Model, SerializerMixin):
    ...
    task_assignments = db.relationship('TaskAssignment', backref='task')
